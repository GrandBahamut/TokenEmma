...
contract Bahamut is Initializable, ERC20Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        __ERC20_init("Bahamut", "BHM");
        __Ownable_init();
        __UUPSUpgradeable_init();

        _mint(msg.sender, 12000000000000000000 * 10 ** decimals());
    }
